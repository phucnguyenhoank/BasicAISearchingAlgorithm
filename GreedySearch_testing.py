...
heuristic_map = dict(A = 123, B = 82, C = 118, D = 115, E = 72, F = 40, G = 0, H = 70, I = 40)
# start a goal must be like this for along with heuristic_map
start_node_name = 'S'
goal_node_name = 'G'

greedy_search = GreedySearch.GrdSearch(problem_map, heuristic_map)
